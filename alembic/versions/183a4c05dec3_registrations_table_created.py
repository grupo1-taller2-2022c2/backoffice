...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            {"method": "federatedidentity", "date_registered": yesterday},
            {"method": "mailpassword", "date_registered": yesterday},
            {"method": "mailpassword", "date_registered": one_month_ago},
            {"method": "mailpassword", "date_registered": three_months_ago},
            {"method": "federatedidentity", "date_registered": one_week_ago},
            {"method": "mailpassword", "date_registered": one_week_ago},
            {"method": "mailpassword", "date_registered": one_week_ago},
            {"method": "mailpassword", "date_registered": two_weeks_ago},
            {"method": "mailpassword", "date_registered": two_weeks_ago},
            {"method": "federatedidentity", "date_registered": three_months_ago},
            {"method": "mailpassword", "date_registered": one_month_ago},
            {"method": "mailpassword", "date_registered": three_months_ago},
        ],
    )
